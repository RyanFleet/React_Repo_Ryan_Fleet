...
const Logout = (props) => {
  ...
  return (
    <div>
      <Link onClick={logoutHandle} id='logout' className='text-white' to={'/logout'}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-unindent" viewBox="0 0 16 16">
        ...
        <path fillRule="evenodd" d="M3.5 4a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 1 0v-7a.5.5 0 0 0-.5-.5Z" /></svg> Logout</Link>
    </div>
  )
}
