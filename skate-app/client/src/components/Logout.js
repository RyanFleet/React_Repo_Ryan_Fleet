...
const Logout = (props) => {
  ...
  return (
    <div className=''>  
      <Link onClick={logoutHandle} id='logout' className='text-white' to={'/logout'}><div className='d-flex flex-row align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-unindent" viewBox="0 0 16 16">
