...
const Almost = (props) => {
    ...
    return (
        <div className='bg-white container-fluid'>
            <div className='p-3'>
                <img className='w-50 h-50' src={require('../images/3ea0aa2a-2d1a-4ecc-82c4-3f2dc704c97f.png')} alt='almost' />
            </div>
            <div className='d-flex flex-wrap'>
            {
                    videos.filter(video => video.company === 'Almost').map((video, index) => {
