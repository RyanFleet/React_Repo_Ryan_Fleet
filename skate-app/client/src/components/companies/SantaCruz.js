    ...
    useEffect(() => {
        ...
        return (
            <div className='bg-white container-fluid'>
                            <div className='p-3'>
                <img className='w-25 h-25' src={require('../images/santa-cruz-skateboards.png')} alt='santa-cruz' />
            </div>
            <div className='d-flex flex-wrap'>
                {
                    videos.filter(video => video.company === 'Santa Cruz').map((video, index) => {
