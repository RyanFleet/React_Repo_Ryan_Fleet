    ...
    useEffect(() => {
        ...
        return (
            <div className='bg-white container-fluid'>
                            <div className='p-3'>
                <img className='w-25 h-50' src={require('../images/bronze56k.jpg')} alt='bronze56k' />
            </div>
            {
                videos.filter(video => video.company === 'Bronze 56k').map((video, index) => {
